...
class TenancyApplicationService:
    ...
    def create_membership(
        ...
        *,
        ...
        if self._memberships.find(identity_id, tenant_id) is not None:
    ...
    def activate_membership(self, membership_id: MembershipId) -> Membership:
    ...
    def _require_membership(self, membership_id: MembershipId) -> Membership:
